# Adapted from https://github.com/huggingface/transformers/blob/95900916ab2d33d813bc02668d035c1538312273/examples/pytorch/text-classification/run_classification.py
...
import evaluate
import numpy as np
from datasets import Value, load_dataset, disable_caching
...
from modeling.model import CharXmodForSequenceClassification
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.dataset_name == "gdi-vardial-2019":
            from evaluation.gdi.gdi_datasets import GDIVardial2019Dataset
            raw_datasets = GDIVardial2019Dataset().dataset
        else:
    ...
    if is_char_xmod:
        model = CharXmodForSequenceClassification.from_pretrained(
